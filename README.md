...
adjectives, and gerund+noun phrases are allowed; standalone gerunds, pronouns,
finite verbs, contraction fragments, stopwords, and proper nouns are excluded.
The analyzer also uses document-level longest-match suppression, so a character with
